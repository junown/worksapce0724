<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.ArrayList, com.kh.el.movel.vo.Person"%>
...
<body>
	...
	<p>
		...
		- scope속성을 생력하면 모든 scope에서 같은 이름을 찾아 제거함
	</p>
	...
	<a herf="list.do?color=black&item=5">기존방식의 요청</a>
