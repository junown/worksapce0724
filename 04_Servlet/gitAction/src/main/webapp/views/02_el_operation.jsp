...
<body>
	...
	<%-- el구문 안에서 문자열 리터럴값은 '',""를 구분하지 않음. --%>
	strThree와 "hello"와 일치하는가? ${strThree == "hello"} 또는 ${strThree eq 'hello'} <br>
	
	<h3>4. 객체가 null인지 아닌지, list가 비어있는지 확인</h3>
	personOne이 nul인가? ${ personOne == null} 또는 ${personOne eq null } 또는 ${ empty personOne} <br>
	personTwo이 nul인가? ${ personTwo == null} 또는 ${personTwo eq null } 또는 ${ empty personTwo} <br>
	
	personTwo이 nul이 아닌가? ${ personTwo != null} 또는 ${personTwo ne null } 또는 ${not empty personTwo} <br>
