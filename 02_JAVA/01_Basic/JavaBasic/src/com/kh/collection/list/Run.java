...
public class Run {
	 ...
	 * 
	 * - 자료구조 : 데이터를 보다 효율적으로 관리(추가, 삭제, 조회, 정렬, 수정)할 수 있도록 구조
	 * 
	 * */
	public static void main(String[] args) {

		//List(순서O, 중복 허용)
		//ArrayList, LinkedList(노드 기반), Vector, Stack(Vector기반 LIFO구조)
		...
		//지정된 크키보다 더 많이 추가해도 에러가 발생하지 않음. 장점1 크기제약x
