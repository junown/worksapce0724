...
public class For {
	 ...
	 * 		  매번 반복문의 코드를 실행하기 전에 확힌하며 보통 초기식에서 제시된 변수를 활용하여 조건식을 정함.
	 * 
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("1~100까지의 짝수 합 : " + sum1);
		System.out.println("\n--------------------------------------------");
		 ...
		 * 
		 * Math.random() 호출시 -> 0.0~0.999999999999사이의 랜덤값을 반환
		...
		System.out.println("random 수 : " + ran);
		System.out.println("1~n까지의 합 : " + sum2);
