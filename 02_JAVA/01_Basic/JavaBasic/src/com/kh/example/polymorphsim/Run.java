package com.kh.example.polymorphsim;
...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 * 		  실제로 어디까지 접근이 가능한가 =     실제로 어떤형태의 메모라가 생성되는가
		 * 
