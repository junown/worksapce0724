...
public class Variable {
	...
	public static void main(String[] args) {
		...
		//참과거짓을 표현하는 자룧ㅇ으로 isTrue라는 이름의 변수를 선언
		boolean isTrue = false; //선언과 동시에 false라는 값을 대입
		isTrue = true;
		System.out.println(isTrue);
		
		//실수형(수숫점6자리까지 사용) 자료형으로 num2라는 이름의 변수를 선언
		float num2;
		num2 = 3.14123123123123f;
...
//		MY_AGE = 111;  // 값을 한번 초기화하면 더이상 변경할 수 없음.
		 ...
		 * ex) USER_NAME, TOTAL_PRICE
		 * 
		 * 케밥케이스 : 단어를 소문자로 작성하되 문자와 문자사이클 파이폰(-)으로 이어주는 것(html속성, url, 설정파일등)
