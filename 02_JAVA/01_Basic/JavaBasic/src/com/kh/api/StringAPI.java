...
public class StringAPI {
	public void method01() {
		...
		//String클래스에 toString매서드는 이미 오버라이딩되어있음
		//그래서 참조변수 출력시 Object의 toString형식(타입@주소값@16진수)이 아니라 String의 저장된 문자열이 반환됨.
		
		System.out.println(str1 == str2);
		//String객체의 주소값을 비교하기 때문에 false가 나옴
		
		System.out.println(str1.equals(str2));
		//String클래스에는 equals메서드도 이미 오바리이딩 되어있음(주소값비고가 아니라 문자열 값을 비교하도록)
		...
		str3 = "bye";
		System.out.println(System.identityHashCode(str3));
		//String 리터럴의 특성상 참조변수에 값을 변경하는 순간 기존 문자열 자리에서 문자열 메모레에 값을 변경하는게 이날
	...
	public void method02() {
		...
		System.out.println("모든 문자열 대문자로 변환 : " + str1.toLowerCase());
