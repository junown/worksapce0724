...
public class MemberMenu {
	...
	public void bulkInsertMembers() {
		System.out.println("========= 회원 여려명 추가 =========");
		System.out.println("회원 추가할 명수 : ");
		int people = sc.nextInt();
		System.out.println("");
	}
	
	public void bulkDeleteMembers() {
		System.out.println("========= 회원 여러명 제거 =========");
		System.out.println("회원 제거할 명수 : ");
		int people = sc.nextInt();
	}
	
	public void keywordMember() {
		System.out.println("========= 회원이름 키워드 검색 =========");
		System.out.println("키워드 : ");
		String keyword = sc.nextLine();
		
		mc.keywordMember(keyword);
	}
