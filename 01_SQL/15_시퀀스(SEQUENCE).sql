...
/*
    2. 시퀀스 사용
    시퀀스명.NXTVAL : 다음 숫자 발생(INCREMENT 만큼 증가)
...
SELECT SQE_EMPNO.CURRVAL FROM DUAL; --에러발생

SELECT SQE_EMPNO.NEXTVAL FROM DUAL; --300
SELECT SQE_EMPNO.CURRVAL FROM DUAL; --300
SELECT SQE_EMPNO.NEXTVAL FROM DUAL; --305
SELECT SQE_EMPNO.NEXTVAL FROM DUAL; --310

SELECT SQE_EMPNO.NEXTVAL FROM DUAL; --MAXVALUE 310 -> 에러발생
