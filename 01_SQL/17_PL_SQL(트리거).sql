/*
    ...
    INSERT 시켜줘야한다.
    - 신고횟수가 일정 수를 넘었을 때 묵시적으로 해당 회원을 블랙리스트로 목록에 추가해야할 때.
    ...
    트리거 분류
    *시점(언제 실행되냐?)
    - BEFORE TRIGGER : 내가 지정한 테이블에 DML이벤트가 실행하기 전에 동작
    - AFTER TRIGGER : 내가 지정한 테이블에 DML이벤트가 실행된 직후 동작
...
INSERT INTO TB_PRODUCT VALUES(SEQ_PCODE.NEXTVAL, '갤럭시S25', '삼성', 15000000, DEFAULT);
INSERT INTO TB_PRODUCT VALUES(SEQ_PCODE.NEXTVAL, '아이폰16', '애플', 13000000, DEFAULT);
INSERT INTO TB_PRODUCT VALUES(SEQ_PCODE.NEXTVAL, '대륙폰', '샤오미', 9900000, DEFAULT);
