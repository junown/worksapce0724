/*
        ...
        데이터베이스에서 사용하는 SQL명령어 중 데이터를 저장할 객체의 구조를 정의하거나 
        변경하는 역할을 한다
...
INSERT INTO MEMBER
VALUES(1, 'USER01', 'PASS01', '홍길동', '남', '010-1111-2222', 'abc@naver.com', '25/07/30');
...
/*
        ...
        - 데이터 무결성 보장을 목적으로 함 -> 데이터베이스에 저장된 데이터가 정확하고 일관되며 실뢰할 수 있는 상태를 유지

        종류 : NOT NULL, UNIQUE, CHECK, PRIMARY KEY, FOREGIN KEY...
*/
...
INSERT INTO MEMBER
VALUES(1, 'USER01', 'PASS01', '홍길동', NULL, '010-1111-2222', 'abc@naver.com', '25/07/30');

SELECT * FROM MEMBER;


INSERT INTO MEMBER
VALUES(2, 'USER02', 'PASS02', '홍길동', '여', '010-1111-2222', 'abCc@naver.com', '25/07/30');
...
INSERT INTO MEMBER
VALUES(1, 'USER02', 'PASS02', '홍길순', NULL, '010-1111-3333', 'abcC@naver.com', '25/07/30');
--기본키에 중복된 값을 감으려고할 때(UNIQUE제약조건 위반)

INSERT INTO MEMBER
VALUES(NULL, 'USER02', 'PASS02', '홍길순', NULL, '010-1111-3333', 'abcC@naver.com', '25/07/30');
--기본키에 NULL 값을 감으려고할 때(NOT NULL제약조건 위반)

INSERT INTO MEMBER
VALUES(2, 'USER02', 'PASS02', '홍길순', NULL, '010-1111-3333', 'abc2C@naver.com', '25/07/30');
--기본키에 NULL 값을 감으려고할 때(NOT NULL제약조건 위반)

INSERT INTO MEMBER
VALUES(3, 'USER03', 'PASS03', '홍길삼', NULL, '010-1111-3333', 'abc3C@naver.com', '25/07/30');
--기본키에 NULL 값을 감으려고할 때(NOT NULL제약조건 위반)
SELECT * FROM MEMBER;

INSERT INTO MEMBER
VALUES(4, 'USER04', 'PASS04', '홍길사', NULL, '010-1111-3333', 'abc4C@naver.com', '25/07/30');
--기본키에 NULL 값을 감으려고할 때(NOT NULL제약조건 위반)
...
INSERT INTO MEM
VALUES(4, 'USER4', 'PASS4', '홍길사', NULL, NULL, NULL, '25/01/01' ,30);
...
/*
    ...
    ->컬럼레벨방식
    컬럼명 자료형 REFERENCES 참조할테이블명 (참조할컬럼명) <<< 이건 생략 가능
...
WHERE GRADE_CODE = 40;
--MEM테이블에서 참조하고있지 않은 40의 GRADE_CODE를 가진 데이터는 삭제가 가능
...
/*
    ...
    *삭제옵션 : 부모테이블의 데이터 삭제시 그 데이터를 참조하고있는 자식테이블의 데이터를 어떻게 처리할 것인가?
    ...
    -ON DELECT RESTRICTED(기본값) : 삭제제한옵션, 자식데이터로부터 쓰이는 부모데이터는 삭제가 안됨.
    -ON DELECT SET NULL : 부모데이터 삭제시 해당 데이터를 사용하고있는 자식데이터의 값을 NULL로 변경
    -ON DELECT CASCADE : 부모데이터 삭제시 해당 데이터를 사용하고있는 자식데이터도 모두 삭제.
*/
...
--자식데이터 중 GRADE_CODE 10인 데이터를 참조하던 데이터는 모두 함께 삭제된다
...
/*
        ...
        제약조건 추가방법
        -PRIMARY KEY : ALTER TABLE 테이블명 ADD [CONSTRAINT 제약조건명] ADD PARIMARY KEY (컬럼명);
